...
using Stemtest.BL.Domain.Sessie.SpelStrategies;
...
namespace Stemtest.BL
{
    public class GameManager
    {
        ...
        public List<Antwoord> GetPartijAntwoorden(int userId, string gekozenPartij)
        {
            LeerkrachtSessie lks =leerkrachtSessies[userId];
            return lks.PartijAntwoorden[gekozenPartij];
        }
